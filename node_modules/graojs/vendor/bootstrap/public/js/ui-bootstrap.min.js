...
.directive('accordion', function () {
  return {
    ...
    transclude: true,
    replace: false,
    templateUrl: '/ui/accordion/accordion.html'
  };
})
...
.directive('accordionGroup', ['$parse', '$transition', '$timeout', function($parse, $transition, $timeout) {
  return {
    ...
    templateUrl:'/ui/accordion/accordion-group.html',
...
angular.module("ui.bootstrap.alert", []).directive('alert', function () {
  return {
    restrict:'EA',
    templateUrl:'/ui/alert/alert.html',
    transclude:true,
    replace:true,
    scope: {
      type: '=',
...
.directive('carousel', [function() {
  return {
    ...
    require: 'carousel',
    templateUrl: '/ui/carousel/carousel.html',
    scope: {
      interval: '=',
      noTransition: '=',
      noPause: '='
...
.directive('slide', ['$parse', function($parse) {
  return {
    ...
    transclude: true,
    replace: true,
    templateUrl: '/ui/carousel/slide.html',
    scope: {
    },
...
.directive( 'datepicker', ['dateFilter', '$parse', 'datepickerConfig', '$log', function (dateFilter, $parse, datepickerConfig, $log) {
  return {
    restrict: 'EA',
    replace: true,
    templateUrl: '/ui/datepicker/datepicker.html',
    scope: {
      dateDisabled: '&'
    },
...
.directive('datepickerPopupWrap', [function() {
  return {
    ...
    replace: true,
    transclude: true,
    templateUrl: '/ui/datepicker/popup.html',
    link:function (scope, element, attrs) {
  ...
  function ($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $transition, $injector) {
    ...
    return {
      ...
      messageBox: function(title, message, buttons){
        return new Dialog({templateUrl: '/ui/dialog/message.html', controller: 'MessageBoxController', resolve:
          {model: function() {
            return {
              title: title,
              message: message,
    ...
    return function $tooltip ( type, prefix, defaultTriggerShow ) {
      ...
      return {
        ...
        link: function link ( scope, element, attrs ) {
          ...
          function showAutoOpen()
          {
          	popupTimeout = $timeout( show, 0 );
        	popupTimeout = $timeout( hide, scope.tt_popupDelay );        	  
          }
          
          // Show the tooltip with delay if specified, otherwise show it immediately
          function showTooltipBind() {
            if ( scope.tt_popupDelay && !scope.tt_isAutoOpen ) {
           ...
           */
          attrs.$observe( prefix+'IsAutoOpen', function ( val ) {
        	  scope.tt_isAutoOpen = val;
          });
          
          attrs.$observe( type, function ( val ) {
            scope.tt_content = val;
            if(scope.tt_isAutoOpen && !scope.tt_isOpen)
            	showAutoOpen();
          });
...
.directive( 'tooltipPopup', function () {
  return {
    restrict: 'E',
    replace: true,
    scope: { content: '@', placement: '@', animation: '&', isOpen: '&', isAutoOpen: '@' },
    templateUrl: '/ui/tooltip/tooltip-popup.html'
  };
})
...
.directive( 'tooltipHtmlUnsafePopup', function () {
  return {
    ...
    replace: true,
    scope: { content: '@', placement: '@', animation: '&', isOpen: '&', isAutoOpen: '@' },
    templateUrl: '/ui/tooltip/tooltip-html-unsafe-popup.html'
  };
})
...
.directive( 'popoverPopup', function () {
  return {
    restrict: 'EA',
    replace: true,
    scope: { title: '@', content: '@', placement: '@', animation: '&', isOpen: '&', isAutoOpen: '@' },
    templateUrl: '/ui/popover/popover.html'
  };
})
...
.directive('progress', function() {
    return {
        ...
        templateUrl: '/ui/progressbar/progress.html',
...
.directive('progressbar', ['$transition', function($transition) {
    return {
        ...
        templateUrl: '/ui/progressbar/bar.html',
...
.directive('tabset', function() {
  return {
    ...
    templateUrl: '/ui/tabs/tabset.html',
...
.directive('tabsetTitles', function($http) {
  return {
    restrict: 'A',
    require: '^tabset',
    templateUrl: '/ui/tabs/tabset-titles.html',
    replace: true,
...
.directive('timepicker', ['padFilter', '$parse', 'timepickerConfig', function (padFilter, $parse, timepickerConfig) {
  return {
    ...
    require:'ngModel',
    replace: true,
    templateUrl: '/ui/timepicker/timepicker.html',
    scope: {
        model: '=ngModel'
    },
    link: function(scope, element, attrs, ngModelCtrl) {
 ...
 */
  ...
  .directive('typeaheadPopup', function () {
    return {
      ...
      replace:true,
      templateUrl:'/ui/typeahead/typeahead-popup.html',
      link:function (scope, element, attrs) {
  ...
  .directive('typeaheadMatch', ['$http', '$templateCache', '$compile', '$parse', function ($http, $templateCache, $compile, $parse) {
    return {
      ...
      link:function (scope, element, attrs) {
        var tplUrl = $parse(attrs.templateUrl)(scope.$parent) || '/ui/typeahead/typeahead-match.html';
